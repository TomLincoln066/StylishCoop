...
class CustomDropDownAdapter(private val currencyDropItems: List<CurrencyDropItem>):
    ArrayAdapter<CurrencyDropItem>(StylishApplication.instance.applicationContext, 0, currencyDropItems) {
