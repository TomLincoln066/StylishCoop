...
abstract class StylishViewingRecordDatabase : RoomDatabase() {

    /**
     * Connects the database to the DAO.
     */
    abstract val viewRecordDatabaseDao: StylishViewingDao
    ...
    companion object {
         ...
         */
        @Volatile
        private var INSTANCE: StylishViewingRecordDatabase? = null
         ...
         */
        fun getInstance(context: Context): StylishViewingRecordDatabase {
            ...
            synchronized(this) {
                ...
                if (instance == null) {
                    instance = Room.databaseBuilder(
                        ...
                        StylishViewingRecordDatabase::class.java,
                        "stylish_record_database"
                    )
